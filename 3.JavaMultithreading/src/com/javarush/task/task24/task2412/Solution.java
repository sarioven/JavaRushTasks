    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
                    ...
                    public int compare(Stock stock1, Stock stock2) {
                        ...
                        Long l1 = ((Date) stock1.get("date")).getTime()/day;
                        Long l2 = ((Date) stock2.get("date")).getTime()/day;

                        return l2.compareTo(l1);
                    }
                }).thenComparing(new Comparator<Stock>() {
                    public int compare(Stock stock1, Stock stock2) {
                        int incom1 = (int)getIncome(stock1);
                        int incom2 = (int)getIncome(stock2);
                        
                        return incom2 - incom1;
                    }
                    
                    private double getIncome(Stock stock) {
